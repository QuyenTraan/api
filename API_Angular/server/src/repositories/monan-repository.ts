...
export class MonAnRepository {
    ...
    public search(id): Promise<pg.QueryResult> {
        // let queryText = " SELECT * FROM account WHERE username LIKE '%minhtuan'; $1";
        let queryText = " select *from mon_an where ten_mon_an_khong_dau=$1";
        console.log(id)
    ...
    public seek(id: number): Promise<pg.QueryResult> {
        let queryText = `
    ...
    public getTop(id): Promise<pg.QueryResult> {
    ...
    public save(ids: number[]): Promise<pg.QueryResult> {
        // let queryText = " SELECT * FROM account WHERE username LIKE '%minhtuan'; $1";
        let queryText = " select * from mon_an Where $1 @> ARRAY[nguyen_lieu ::json->>'id']::int[]";
        console.log(3)
